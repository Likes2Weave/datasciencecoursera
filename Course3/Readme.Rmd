...
## codebook generator alternative
library(dataMaid)
```
...
Assignment File Submitted: final_tidyframe.txt
To read the file: 
my_final_tidyframe <- read.table("final_tidyframe.txt", header = TRUE, row.names = FALSE, sep = ",")
